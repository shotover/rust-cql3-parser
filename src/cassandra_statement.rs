...
use crate::common::{FQName, Identifier, Privilege};
...
mod tests {
    ...
    fn test_select_statements() {
        let stmts = [
            ...
            r#"SELECT "col""umn" from "keyspace"."table" where col='cat''s claws'"#,
        ];
        let expected = [
            "SELECT DISTINCT JSON * FROM table",
            "SELECT column FROM table",
    ...
    fn test_alter_role() {
        let stmts = [
            r#"ALTER ROLE "role""#,
            r#"ALTER ROLE "role" WITH PASSWORD = 'password';"#,
            r#"ALTER ROLE "role" WITH PASSWORD = 'password' AND LOGIN=false;"#,
            r#"ALTER ROLE "role" WITH SUPERUSER=true;"#,
            r#"ALTER ROLE "role" WITH OPTIONS={ 'foo' : 3.14, 'bar' : 'pi' }"#,
        ];
        let expected = [
            r#"ALTER ROLE "role""#,
            r#"ALTER ROLE "role" WITH PASSWORD = 'password'"#,
    ...
    fn test_grant() {
        let stmts = [
            r#"GRANT ALL ON "keyspace".table TO role;"#,
            r#"GRANT ALL PERMISSIONS ON "keyspace".table TO role;"#,
            r#"GRANT ALTER ON "keyspace".table TO role;"#,
            r#"GRANT AUTHORIZE ON "keyspace".table TO role;"#,
            r#"GRANT DESCRIBE ON "keyspace".table TO role;"#,
            r#"GRANT EXECUTE ON "keyspace".table TO role;"#,
            r#"GRANT CREATE ON "keyspace".table TO role;"#,
            r#"GRANT DROP ON "keyspace".table TO role;"#,
            r#"GRANT MODIFY ON "keyspace".table TO role;"#,
            r#"GRANT SELECT ON "keyspace".table TO role;"#,
            ...
            r#"GRANT ALL ON FUNCTION "keyspace".function TO role;"#,
            r#"GRANT ALL ON FUNCTION "function" TO role;"#,
            r#"GRANT ALL ON KEYSPACE "keyspace" TO role;"#,
            r#"GRANT ALL ON ROLE "role" TO role;"#,
            r#"GRANT ALL ON TABLE "keyspace".table TO role;"#,
            r#"GRANT ALL ON TABLE "table" TO role;"#,
            r#"GRANT ALL ON "table" TO role;"#,
        ];
        let expected = [
            r#"GRANT ALL PERMISSIONS ON TABLE "keyspace".table TO role"#,
            r#"GRANT ALL PERMISSIONS ON TABLE "keyspace".table TO role"#,
            r#"GRANT ALTER ON TABLE "keyspace".table TO role"#,
            r#"GRANT AUTHORIZE ON TABLE "keyspace".table TO role"#,
            r#"GRANT DESCRIBE ON TABLE "keyspace".table TO role"#,
            r#"GRANT EXECUTE ON TABLE "keyspace".table TO role"#,
            r#"GRANT CREATE ON TABLE "keyspace".table TO role"#,
            r#"GRANT DROP ON TABLE "keyspace".table TO role"#,
            r#"GRANT MODIFY ON TABLE "keyspace".table TO role"#,
            r#"GRANT SELECT ON TABLE "keyspace".table TO role"#,
            ...
            r#"GRANT ALL PERMISSIONS ON FUNCTION "keyspace".function TO role"#,
            r#"GRANT ALL PERMISSIONS ON FUNCTION "function" TO role"#,
            r#"GRANT ALL PERMISSIONS ON KEYSPACE "keyspace" TO role"#,
            r#"GRANT ALL PERMISSIONS ON ROLE "role" TO role"#,
            r#"GRANT ALL PERMISSIONS ON TABLE "keyspace".table TO role"#,
            r#"GRANT ALL PERMISSIONS ON TABLE "table" TO role"#,
            r#"GRANT ALL PERMISSIONS ON TABLE "table" TO role"#,
        ];
        test_parsing(&expected, &stmts);
    }
    ...
    fn test_revoke() {
        let stmts = [
            r#"REVOKE ALL ON TABLE "keyspace".table FROM role;"#,
            r#"REVOKE ALL PERMISSIONS ON  TABLE"keyspace".table FROM role;"#,
            r#"REVOKE ALTER ON TABLE "keyspace".table FROM role;"#,
            r#"REVOKE AUTHORIZE ON TABLE "keyspace".table FROM role;"#,
            r#"REVOKE DESCRIBE ON TABLE "keyspace".table FROM role;"#,
            r#"REVOKE EXECUTE ON TABLE "keyspace".table FROM role;"#,
            r#"REVOKE CREATE ON TABLE "keyspace".table FROM role;"#,
            r#"REVOKE DROP ON TABLE "keyspace".table FROM role;"#,
            r#"REVOKE MODIFY ON TABLE "keyspace".table FROM role;"#,
            r#"REVOKE SELECT ON TABLE "keyspace".table FROM role;"#,
            ...
            r#"REVOKE ALL ON FUNCTION "keyspace".function FROM role;"#,
            r#"REVOKE ALL ON FUNCTION "function" FROM role;"#,
            r#"REVOKE ALL ON KEYSPACE "keyspace" FROM role;"#,
            r#"REVOKE ALL ON ROLE "role" FROM role;"#,
            r#"REVOKE ALL ON TABLE "keyspace".table FROM role;"#,
            r#"REVOKE ALL ON TABLE "table" FROM role;"#,
            r#"REVOKE ALL ON  TABLE"table" FROM role;"#,
        ];
        let expected = [
            r#"REVOKE ALL PERMISSIONS ON TABLE "keyspace".table FROM role"#,
            ...
            r#"REVOKE ALL PERMISSIONS ON FUNCTION "keyspace".function FROM role"#,
            r#"REVOKE ALL PERMISSIONS ON FUNCTION "function" FROM role"#,
            r#"REVOKE ALL PERMISSIONS ON KEYSPACE "keyspace" FROM role"#,
            r#"REVOKE ALL PERMISSIONS ON ROLE "role" FROM role"#,
            r#"REVOKE ALL PERMISSIONS ON TABLE "keyspace".table FROM role"#,
            r#"REVOKE ALL PERMISSIONS ON TABLE "table" FROM role"#,
            r#"REVOKE ALL PERMISSIONS ON TABLE "table" FROM role"#,
        ];
        test_parsing(&expected, &stmts);
    }
    ...
    fn test_list_permissions() {
        let stmts = [
            "LIST ALL",
            r#"LIST ALL ON TABLE "keyspace".table OF role;"#,
            r#"LIST ALL PERMISSIONS ON  TABLE "keyspace".table OF role;"#,
            r#"LIST ALTER ON TABLE "keyspace".table OF role;"#,
            r#"LIST AUTHORIZE ON TABLE "keyspace".table OF role;"#,
            r#"LIST DESCRIBE ON TABLE "keyspace".table OF role;"#,
            r#"LIST EXECUTE ON TABLE "keyspace".table OF role;"#,
            r#"LIST CREATE ON TABLE "keyspace".table OF role;"#,
            r#"LIST DROP ON TABLE "keyspace".table OF role;"#,
            r#"LIST MODIFY ON TABLE "keyspace".table OF role;"#,
            r#"LIST SELECT ON TABLE "keyspace".table OF role;"#,
            ...
            r#"LIST ALL ON FUNCTION "keyspace".function OF role;"#,
            r#"LIST ALL ON FUNCTION "function" OF role;"#,
            r#"LIST ALL ON KEYSPACE "keyspace" OF role;"#,
            r#"LIST ALL ON ROLE "role" OF role;"#,
            r#"LIST ALL ON TABLE "keyspace".table OF role;"#,
            r#"LIST ALL ON TABLE "table" OF role;"#,
            r#"LIST ALL ON  TABLE "table" OF role;"#,
        ];
        let expected = [
            ...
            r#"LIST ALL PERMISSIONS ON FUNCTION "keyspace".function OF role"#,
            r#"LIST ALL PERMISSIONS ON FUNCTION "function" OF role"#,
            r#"LIST ALL PERMISSIONS ON KEYSPACE "keyspace" OF role"#,
            r#"LIST ALL PERMISSIONS ON ROLE "role" OF role"#,
            r#"LIST ALL PERMISSIONS ON TABLE "keyspace".table OF role"#,
            r#"LIST ALL PERMISSIONS ON TABLE "table" OF role"#,
            r#"LIST ALL PERMISSIONS ON TABLE "table" OF role"#,
        ];
        test_parsing(&expected, &stmts);
    }
    ...
    fn test_create_type() {
        let stmts = [
            r#"CREATE TYPE if not exists keyspace.type ( "col1" TIMESTAMP);"#,
            ...
            r#"CREATE TYPE type ( col1 "foo");"#,
            r#"CREATE TYPE if not exists keyspace.type ( col1 "foo" < "subcol1", TIMESTAMP, BLOB > );"#,
    ...
    fn test_alter_materialized_view() {
        let stmts = [
            r#"ALTER MATERIALIZED VIEW "key""space".mview;"#,
            r#"ALTER MATERIALIZED VIEW "keyspace".mview;"#,
